...
base_footprint 	{  }
trunk 	{ , mass:93, inertiaTensor:[1.49873, -0.007369, -0.189135, 9.49238, 0.000185, 9.01236] }
trunk_1 (trunk) 	{ , shape:mesh, mesh:'meshes/trunk/combined_torso.dae', meschscale=0.001, visual }
...
base_arm (trunk) 	{  Q:[0.539, 0, -0.062, 0.382683, 0, 0, 0.92388], mass:1.697, inertiaTensor:[0.004622, 9e-06, 6e-05, 0.004495, 9e-06, 0.002079] }
base_arm_1 (trunk) 	{  Q:[0.539, 0, -0.062, 0.382683, 0, 0, 0.92388], shape:mesh, color:[0.75294, 0.75294, 0.75294, 1], mesh:'meshes/arm/base_link.dae', visual }
#base_arm_0 (trunk) 	{  Q:[0.539, 0, -0.062, 0.382683, 0, 0, 0.92388], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'meshes/arm/base_link.dae', contact:-2 }
base_arm>z_joint_1 (trunk) 	{  Q:[0.539, 0, 0.09443, 0.653281, 0.270595, 0.653283, -0.2706] }
lf_haa_joint (trunk>lf_haa_joint) 	{ , joint:hingeX, limits:[-0.733038, 0.401426, 12, 173, 1], ctrl_limits:[12, 173, 1] }
rf_haa_joint (trunk>rf_haa_joint) 	{ , joint:hingeX, limits:[-0.733038, 0.401426, 12, 173, 1], ctrl_limits:[12, 173, 1] }
lh_haa_joint (trunk>lh_haa_joint) 	{ , joint:hingeX, limits:[-0.733038, 0.401426, 12, 173, 1], ctrl_limits:[12, 173, 1] }
rh_haa_joint (trunk>rh_haa_joint) 	{ , joint:hingeX, limits:[-0.733038, 0.401426, 12, 173, 1], ctrl_limits:[12, 173, 1] }
...
lf_hipassembly_1 (lf_haa_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:cylinder, size:[0, 0, 0.117, 0.0444], visual }
...
rf_hipassembly_1 (rf_haa_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:cylinder, size:[0, 0, 0.117, 0.0444], visual }
rf_hipassembly>rf_hfe_joint (rf_haa_joint) 	{  Q:[-0, -0.117, 0, -0.707107, 1.11022e-16, -5.55112e-17, -0.707107] }
lh_hipassembly (lh_haa_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], mass:4.97328, inertiaTensor:[0.011231, -0.000592, 0.000225, 0.015768, 0.000224, 0.016863] }
lh_hipassembly_1 (lh_haa_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:cylinder, size:[0, 0, 0.117, 0.0444], visual }
lh_hipassembly>lh_hfe_joint (lh_haa_joint) 	{  Q:[-0, -0.117, 0, -0.707107, -1.11022e-16, -5.55112e-17, 0.707107] }
rh_hipassembly (rh_haa_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], mass:4.97328, inertiaTensor:[0.011231, -0.000592, 0.000225, 0.015768, 0.000224, 0.016863] }
rh_hipassembly_1 (rh_haa_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:cylinder, size:[0, 0, 0.117, 0.0444], visual }
...
lf_hfe_joint (lf_hipassembly>lf_hfe_joint) 	{ , joint:hingeX, limits:[0.261799, 2.18166, 12, 208, 1], ctrl_limits:[12, 208, 1] }
rf_hfe_joint (rf_hipassembly>rf_hfe_joint) 	{ , joint:hingeX, limits:[0.261799, 2.18166, 12, 208, 1], ctrl_limits:[12, 208, 1] }
lh_hfe_joint (lh_hipassembly>lh_hfe_joint) 	{ , joint:hingeX, limits:[0.261799, 2.18166, 12, 208, 1], ctrl_limits:[12, 208, 1] }
rh_hfe_joint (rh_hipassembly>rh_hfe_joint) 	{ , joint:hingeX, limits:[0.261799, 2.18166, 12, 208, 1], ctrl_limits:[12, 208, 1] }
...
lf_upperleg_1 (lf_hfe_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, mesh:'meshes/leg/upperleg.dae', meshscale=0.001, visual }
...
lf_kfe_joint (lf_upperleg>lf_kfe_joint) 	{ , joint:hingeX, limits:[-2.77001, -0.669857, 12, 249, 1], ctrl_limits:[12, 249, 1] }
rf_kfe_joint (rf_upperleg>rf_kfe_joint) 	{ , joint:hingeX, limits:[-2.77001, -0.669857, 12, 249, 1], ctrl_limits:[12, 249, 1] }
lh_kfe_joint (lh_upperleg>lh_kfe_joint) 	{ , joint:hingeX, limits:[-2.77001, -0.669857, 12, 249, 1], ctrl_limits:[12, 249, 1] }
rh_kfe_joint (rh_upperleg>rh_kfe_joint) 	{ , joint:hingeX, limits:[-2.77001, -0.669857, 12, 249, 1], ctrl_limits:[12, 249, 1] }
