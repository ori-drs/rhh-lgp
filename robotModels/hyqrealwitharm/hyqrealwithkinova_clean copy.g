...
base_footprint 	{Q:[0, 0, 0.4, 1, 0, 0, 0]  }
#base_footprint 	{}
base_pitch {}
jointBase_pitch (world base_pitch) { joint:hingeY, limits: [-0.2, 0.2] }
...
lf_hfe_joint (lf_hipassembly>lf_hfe_joint) 	{ , joint:hingeY, limits:[0.261799, 2.18166, 12, 208, 1], ctrl_limits:[12, 208, 1], Q:[-0.1, -0.1, -0, 0, 0, 0.0, 1] }
...
lf_kfe_joint (lf_upperleg>lf_kfe_joint) 	{ , joint:hingeY, limits:[-2.77001, -0.669857, 12, 249, 1], ctrl_limits:[12, 249, 1] }
rf_kfe_joint (rf_upperleg>rf_kfe_joint) 	{ , joint:hingeY, limits:[-2.77001, -0.669857, 12, 249, 1], ctrl_limits:[12, 249, 1] }
lh_kfe_joint (lh_upperleg>lh_kfe_joint) 	{ , joint:hingeY, limits:[-2.77001, -0.669857, 12, 249, 1], ctrl_limits:[12, 249, 1] }
rh_kfe_joint (rh_upperleg>rh_kfe_joint) 	{ , joint:hingeY, limits:[-2.77001, -0.669857, 12, 249, 1], ctrl_limits:[12, 249, 1] }
