shape hyqrealwithkinovaG (end_effector_link){ rel=<T d(-90 0 1 0) d(-90 0 0 1) t(0 0.05 0.0)> type=ssBox size=[.03 .03 .05 .01] color=[1 1 0] contact logical:{ gripper } }
shape baseG (worldTranslationRotation){type=ssBox size=[.03 .03 .05 .01] color=[1 1 0 0] logical:{ base } } 
...
#shape coll_legs (worldTranslationRotation){ type=ssBox rel=<T 0.08 0 0.15 -2 0 0 0 >  size=[ 1.4 0.7 0.4 0.1 ]  contact=-2, color:[1.,1.,1.,0.001] }
shape coll_base (base_pitch){ type=ssBox rel=<T 0.08 0 -0.03 0.2 0 0 0 >  size=[ 1.3 0.7 0.5 0.1 ]  contact=-2, color:[1.,1.,1.,0.001 ]  }
...
#shape coll_wrist (spherical_wrist_2_link){ type=ssBox rel=<T 0.0 -0.07 0.0 1 0 0 0 >  size=[ 0.15 0.2 0.01 0.038 ]  contact=-2, color:[1.,1.,1.,1]  }
...
#shape obj0 (world) { rel:<t(3.1373 0.0365 0.03825) d(90 1 0 0)> type=ssBox size=[.2745 .073 .0765 .002], contact=2, color=[0 1 0] , logical={ object }}
#shape obj0 (world) { rel:<t(2 0.0 0.03825) d(90 1 0 0)> type=ssBox size=[.2745 .073 .0765 .002], contact=2, color=[0 1 0] , logical={ object }}
