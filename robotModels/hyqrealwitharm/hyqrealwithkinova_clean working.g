base world{ }
base_footprint 	{Q:[0, 0, 0.6, 1, 0, 0, 0]  }
#base_footprint 	{}
worldTranslationRotation (world base_footprint){ joint:transXYPhi,  limits: [-0.1, 0.1, -2, 2, -0.1, 0.1], ctrl_H=20 }
...
lf_haa_joint (trunk>lf_haa_joint) 	{ , joint:hingeX, limits:[-0.733038, 0.401426, 12, 173, 1], ctrl_limits:[12, 173, 1], Q:[0, 0.0, 0.00, 0.7071068, 0, 0, 0.7071068 ]}
rf_haa_joint (trunk>rf_haa_joint) 	{ , joint:hingeX, limits:[-0.733038, 0.401426, 12, 173, 1], ctrl_limits:[12, 173, 1], Q:[0, 0.0, 0.00, -0.7071068, 0, 0, -0.7071068 ] }
lh_haa_joint (trunk>lh_haa_joint) 	{ , joint:hingeX, limits:[-0.733038, 0.401426, 12, 173, 1], ctrl_limits:[12, 173, 1], Q:[0, 0.0, 0.00, 0.7071068, 0, 0, 0.7071068 ] }
rh_haa_joint (trunk>rh_haa_joint) 	{ , joint:hingeX, limits:[-0.733038, 0.401426, 12, 173, 1], ctrl_limits:[12, 173, 1], Q:[0, 0.0, 0.00, -0.7071068, 0, 0, -0.7071068 ]  }
z_joint_1 (base_arm>z_joint_1) 	{ , joint:hingeX, limits:[-100, 100, 0, 1.3963, 520, 1], ctrl_limits:[1.3963, 520, 1] }
...
lf_hfe_joint (lf_hipassembly>lf_hfe_joint) 	{ , joint:hingeX, limits:[0.261799, 2.18166, 12, 208, 1], ctrl_limits:[12, 208, 1], Q:[-0.1, -0.1, -0, 0, 0, 0.0, 1] }
rf_hfe_joint (rf_hipassembly>rf_hfe_joint) 	{ , joint:hingeX, limits:[0.261799, 2.18166, 12, 208, 1], ctrl_limits:[12, 208, 1],Q:[0.1, 0.1, -0, 0, 0, 0.0, 1] }
lh_hfe_joint (lh_hipassembly>lh_hfe_joint) 	{ , joint:hingeX, limits:[0.261799, 2.18166, 12, 208, 1], ctrl_limits:[12, 208, 1],Q:[-0.1, -0.1, -0, 0, 0, 0.0, 1] }
rh_hfe_joint (rh_hipassembly>rh_hfe_joint) 	{ , joint:hingeX, limits:[0.261799, 2.18166, 12, 208, 1], ctrl_limits:[12, 208, 1],Q:[0.1, 0.1, -0, 0, 0, 0.0, 1] }
...
z_joint_3 (half_arm_1_link>z_joint_3) 	{ , joint:hingeX, limits:[-100, 100, 0, 1.3963, 520, 1], ctrl_limits:[1.3963, 520, 1] }
...
#z_joint_4 (half_arm_2_link>z_joint_4) 	{ , joint:hingeX, limits:[-2.66, 2.66, 1.3963, 520, 1], ctrl_limits:[6.24, 520, 1] }
...
z_joint_5 (forearm_link>z_joint_5) 	{ , joint:hingeX, limits:[-100, 100, 0, 1.2218, 320, 1], ctrl_limits:[1.2218, 320, 1] }
#z_joint_5 (forearm_link>z_joint_5) 	{ , joint:hingeX, limits:[0, 0, 0, 1.2218, 320, 1], ctrl_limits:[6.24, 320, 1] }
...
#z_joint_6 (spherical_wrist_1_link>z_joint_6) 	{ , joint:hingeX, limits:[-2.23, 2.23, 1.2218, 320, 1], ctrl_limits:[6.24, 320, 1] }
...
z_joint_7 (spherical_wrist_2_link>z_joint_7) 	{ , joint:hingeX, limits:[-100, 100, 0, 1.2218, 320, 1], ctrl_limits:[1.2218, 320, 1] }
