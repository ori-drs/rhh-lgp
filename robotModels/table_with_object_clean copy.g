...
Frame table2{ shape:ssBox, X=<T t(3. 0 .15)>, size=[.4 2.2 .3 .02], color=[.3 .3 .3] fixed, contact:-2, logical={ table } }
...
#handle_1 (handle) 	{ , shape:box, size:[0.02, 0.02, 0.08, 0], visual }
#handle_0 (handle) 	{ , shape:box, size:[0.02, 0.02, 0.08, 0], color:[0.8, 0.2, 0.2, 0.5], contact:-2 }
#shape coll_load_link_Yaw (load_link_Yaw){  shape:box, size:[0.1, 0.1, 0.2, 0.5], color:[1, 0, 0], contact:-2  }
#shape coll_handle_joint_left_0 (handle_joint_left){  shape:cylinder, size:[0, 0, 0.08, 0.01], color:[1, 0, 0], contact:-2 }
#shape coll_handle_joint_right_0 (handle_joint_right){ shape:cylinder, size:[0, 0, 0.08, 0.01], color:[1, 0, 0], contact:-2 }
#shape coll_handle_0 (handle){ shape:box, size:[0.02, 0.02, 0.08, 0], color:[1, 0, 0], contact:-2 }
