...
base_link_0 (base_footprint) 	{ , shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/base_v2/base.stl'}
...
arm_lift_link_0 (arm_lift_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/arm_v0/shoulder.stl'}
...
arm_flex_link_0 (arm_flex_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, 0, -0.707107], shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/arm_v0/arm_flex.stl'}
...
arm_roll_link_0 (arm_roll_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/arm_v0/arm_roll.stl'}
...
head_rgbd_sensor_link_0 (head_tilt_joint) 	{  Q:[-0.022, -0.079796, 0.215172, -0.707107, 0.707107, 1.73117e-12, -1.73112e-12], shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/sensors/rgbd.stl', }
...
wrist_flex_link_0 (wrist_flex_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, 0, -0.707107], shape:cylinder, size:[0, 0, 0.04, 0.017], color:[0.8, 0.2, 0.2, 0] }
...
wrist_roll_link_0 (wrist_roll_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/wrist_v0/wrist_roll.stl'}
...
hand_l_spring_proximal_link_0 (hand_l_spring_proximal_joint) 	{ , shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/hand_v0/l_proximal.stl'}
...
hand_r_spring_proximal_link_0 (hand_r_spring_proximal_joint) 	{  Q:[-0, -0, -0, -6.12323e-17, 0, -0, 1], shape:mesh,  color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/hand_v0/r_proximal.stl'}
