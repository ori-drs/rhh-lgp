...
base_link_1 (base_footprint) 	{ , shape:mesh, mesh:'hsr_meshes/meshes/base_v2/base.stl', visual }
base_link_0 (base_footprint) 	{ , shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/base_v2/base.stl', contact:-2 }
base_range_sensor_link_1 (base_footprint) 	{  Q:[0.1675, 0, 0.1844, 1, 0, 0, 0], shape:mesh, mesh:'hsr_meshes/meshes/sensors/laser.stl', visual }
base_range_sensor_link_0 (base_footprint) 	{  Q:[0.1675, 0, 0.1844, 1, 0, 0, 0], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/sensors/laser.stl', contact:-2 }
...
arm_lift_link_1 (arm_lift_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, mesh:'hsr_meshes/meshes/arm_v0/shoulder.stl', visual }
arm_lift_link_0 (arm_lift_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/arm_v0/shoulder.stl', contact:-2 }
...
torso_lift_link_1 (torso_lift_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, mesh:'hsr_meshes/meshes/torso_v0/torso.stl', visual }
torso_lift_link_0 (torso_lift_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/torso_v0/torso.stl', contact:-2 }
...
arm_flex_link_1 (arm_flex_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, 0, -0.707107], shape:mesh, mesh:'hsr_meshes/meshes/arm_v0/arm_flex.stl', visual }
arm_flex_link_0 (arm_flex_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, 0, -0.707107], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/arm_v0/arm_flex.stl', contact:-2 }
...
head_pan_link_1 (head_pan_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, mesh:'hsr_meshes/meshes/head_v1/head_pan.stl', visual }
head_pan_link_0 (head_pan_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/head_v1/head_pan.stl', contact:-2 }
...
arm_roll_link_1 (arm_roll_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, mesh:'hsr_meshes/meshes/arm_v0/arm_roll.stl', visual }
arm_roll_link_0 (arm_roll_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/arm_v0/arm_roll.stl', contact:-2 }
...
head_tilt_link_1 (head_tilt_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, 0, -0.707107], shape:mesh, mesh:'hsr_meshes/meshes/head_v1/head.stl', visual }
head_tilt_link_1 (head_tilt_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, 0, -0.707107], shape:mesh, mesh:'hsr_meshes/meshes/head_v1/tablet.stl', visual }
head_tilt_link_0 (head_tilt_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, 0, -0.707107], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/head_v1/head.stl', contact:-2 }
head_tilt_link_0 (head_tilt_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, 0, -0.707107], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/head_v1/tablet.stl', contact:-2 }
head_l_stereo_camera_link_1 (head_tilt_joint) 	{  Q:[-0.07, 0.02, 0.061, -0.707107, 0.707107, 1.73117e-12, -1.73112e-12], shape:mesh, mesh:'hsr_meshes/meshes/sensors/head_camera.dae', visual }
head_r_stereo_camera_link_1 (head_tilt_joint) 	{  Q:[0.07, 0.02, 0.061, -0.707107, 0.707107, 1.73117e-12, -1.73112e-12], shape:mesh, mesh:'hsr_meshes/meshes/sensors/head_camera.dae', visual }
head_rgbd_sensor_link_1 (head_tilt_joint) 	{  Q:[-0.022, -0.079796, 0.215172, -0.707107, 0.707107, 1.73117e-12, -1.73112e-12], shape:mesh, mesh:'hsr_meshes/meshes/sensors/rgbd.stl', visual }
head_rgbd_sensor_link_0 (head_tilt_joint) 	{  Q:[-0.022, -0.079796, 0.215172, -0.707107, 0.707107, 1.73117e-12, -1.73112e-12], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/sensors/rgbd.stl', contact:-2 }
...
wrist_flex_link_1 (wrist_flex_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, 0, -0.707107], shape:mesh, mesh:'hsr_meshes/meshes/wrist_v0/wrist_flex.dae', colorName:"body_sub", visual }
...
wrist_roll_link_1 (wrist_roll_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, mesh:'hsr_meshes/meshes/wrist_v0/wrist_roll.stl', visual }
wrist_roll_link_0 (wrist_roll_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/wrist_v0/wrist_roll.stl', contact:-2 }
...
hand_palm_link_0 (wrist_roll_joint) 	{  Q:[0.1405, 0, -0.012, 7.3123e-14, -0.707107, 7.3123e-14, -0.707107], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/hand_v0/palm.stl', contact:-2 }
...
hand_l_spring_proximal_link_1 (hand_l_spring_proximal_joint) 	{ , shape:mesh, mesh:'hsr_meshes/meshes/hand_v0/l_proximal.stl', colorName:"body_sub", visual }
hand_l_spring_proximal_link_0 (hand_l_spring_proximal_joint) 	{ , shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/hand_v0/l_proximal.stl', contact:-2 }
...
hand_r_spring_proximal_link_1 (hand_r_spring_proximal_joint) 	{  Q:[-0, -0, -0, -6.12323e-17, 0, -0, 1], shape:mesh, mesh:'hsr_meshes/meshes/hand_v0/r_proximal.stl', colorName:"body_sub", visual }
hand_r_spring_proximal_link_0 (hand_r_spring_proximal_joint) 	{  Q:[-0, -0, -0, -6.12323e-17, 0, -0, 1], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/hand_v0/r_proximal.stl', contact:-2 }
...
hand_l_distal_link_1 (hand_l_distal_joint) 	{ , shape:mesh, mesh:'hsr_meshes/meshes/hand_v0/l_distal.stl', colorName:"body_sub", visual }
hand_l_distal_link_0 (hand_l_distal_joint) 	{ , shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/hand_v0/l_distal.stl', contact:-2 }
...
hand_r_distal_link_1 (hand_r_distal_joint) 	{  Q:[-0, -0, -0, -6.12323e-17, 0, -0, 1], shape:mesh, mesh:'hsr_meshes/meshes/hand_v0/r_distal.stl', colorName:"body_sub", visual }
hand_r_distal_link_0 (hand_r_distal_joint) 	{  Q:[-0, -0, -0, -6.12323e-17, 0, -0, 1], shape:mesh, color:[0.8, 0.2, 0.2, 0.5], mesh:'hsr_meshes/meshes/hand_v0/r_distal.stl'}
