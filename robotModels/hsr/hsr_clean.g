...
base_range_sensor_link_0 (base_footprint) 	{  Q:[0.1675, 0, 0.1844, 1, 0, 0, 0], shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/sensors/laser.stl', contact:-2 }
...
torso_lift_link_0 (torso_lift_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/torso_v0/torso.stl', contact:-2 }
...
base_r_drive_wheel_link_0 (base_r_drive_wheel_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, 0, 0.707107], shape:cylinder, size:[0, 0, 0.03, 0.04], color:[0.8, 0.2, 0.2, 0] contact:-2 }
...
base_l_drive_wheel_link_0 (base_l_drive_wheel_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, 0, 0.707107], shape:cylinder, size:[0, 0, 0.03, 0.04], color:[0.8, 0.2, 0.2, 0] contact:-2 }
...
head_pan_link_0 (head_pan_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/head_v1/head_pan.stl', contact:-2 }
...
head_tilt_link_0 (head_tilt_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, 0, -0.707107], shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/head_v1/head.stl', contact:-2 }
head_tilt_link_0 (head_tilt_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, 0, -0.707107], shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/head_v1/tablet.stl', contact:-2 }
...
base_r_passive_wheel_z_link_0 (base_r_passive_wheel_z_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:sphere, size:[0, 0, 0, 0.03], color:[0.8, 0.2, 0.2, 0] contact:-2 }
...
base_l_passive_wheel_z_link_0 (base_l_passive_wheel_z_joint) 	{  Q:[-0, -0, -0, -0.707107, 0, -0.707107, 0], shape:sphere, size:[0, 0, 0, 0.03], color:[0.8, 0.2, 0.2, 0] contact:-2 }
...
hand_palm_link_0 (wrist_roll_joint) 	{  Q:[0.1405, 0, -0.012, 7.3123e-14, -0.707107, 7.3123e-14, -0.707107], shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/hand_v0/palm.stl', contact:-2 }
...
hand_l_distal_link_0 (hand_l_distal_joint) 	{ , shape:mesh, color:[0.8, 0.2, 0.2, 0] mesh:'hsr_meshes/meshes/hand_v0/l_distal.stl', contact:-2 }
