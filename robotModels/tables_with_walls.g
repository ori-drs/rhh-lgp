...
Frame table2 {shape:ssBox, X=<T t(2.2 -1.25 .6)>, size=[1 1.9 .1 .02], color=[.3 .3 .3] fixed, contact, logical={} }


Frame tray (table2) {shape:ssBox, Q=<T t(0. 0 0.07)>, size=[.15 .15 .04 .02], color=[0 1 0] fixed, contact,logical={ table }}
