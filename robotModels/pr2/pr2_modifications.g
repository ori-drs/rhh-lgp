...
shape pr2R (r_wrist_roll_link){ rel=<T d(-90 0 1 0) d(-90 0 0 1) t(0.0 -0.01 -.12)> type=ssBox size=[.03 .03 .05 .01] color=[1 1 0 0] logical:{ gripper } }
shape pr2L (l_wrist_roll_link) { rel=<T d(-90 0 1 0) d(-90 0 0 1) t(0 -0.05 -.1)> type=ssBox size=[.03 .03 .05 .01] color=[1 1 0 0] logical:{  }}
